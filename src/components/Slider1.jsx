...
const Slider1 = () => {
    ...
    return (
        <div className="bg-[#2D39490A] ">
            <div className="xl:ml-auto  max-w-[1600px]  max-xl:mx-auto max-lg:px-3 pt-7 md:pt-9 lg:pt-[70px] min-[1280px]:mt-[300px] pb-5 sm:pb-7 md:pb-12 lg:pb-[98px] relative overflow-x-clip">
